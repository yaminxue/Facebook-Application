...
public class FragmentIndicator extends LinearLayout implements OnClickListener {
	...
	private void init() {
		...
		mIndicators[1] = createIndicator(R.drawable.ic_action_chat,
				R.string.tab_chat, COLOR_UNSELECT, TAG_ICON_1, TAG_TEXT_1);
		mIndicators[1].setBackgroundColor(Color.alpha(0));
		mIndicators[1].setTag(Integer.valueOf(1));
		mIndicators[1].setOnClickListener(this);
		addView(mIndicators[1]);
		mIndicators[2] = createIndicator(R.drawable.ic_action_star,
				R.string.tab_discover, COLOR_UNSELECT, TAG_ICON_2, TAG_TEXT_2);
	...
	public static void setIndicator(int which) {
		...
		case 1:
			...
			prevIcon.setImageResource(R.drawable.ic_action_chat);
		...
		case 2:
			...
			prevIcon.setImageResource(R.drawable.ic_action_star);
		...
		case 1:
			...
			currIcon.setImageResource(R.drawable.ic_action_chat);
		...
		case 2:
			...
			currIcon.setImageResource(R.drawable.ic_action_star);
